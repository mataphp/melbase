 ...
 * accepté les termes. 
 **/
package fr.aphp.sls.melbase.dao.ctcae;
...
/**
 * 
 * Interface pour le DAO du bean de domaine Term.
 * 
 * Date: 09/09/2012
 * 
 ...
 * @version 1.0
 */
public interface TermDao extends GenericDaoJpa<Term, Integer> {
	
	/**
	 * Recherche toutes les terms par leur soc.
	 * @param soc
	 * @return Liste de Terms.
	 */
	List<Term> findBySoc(Soc soc);
	
	/**
	 * Recherche tous les terms en fonction de leur 
	 * contenu (like)
	 * @param term String
	 * @return Liste de Terms.
	 */
	List<Term> findByTermLike(String t);
