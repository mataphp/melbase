 ...
 * l'activité de banque clinico-biologiques.
 *
 ...
 * accepté les termes. 
 **/
package fr.aphp.sls.melbase.dao.impl;
...
import fr.aphp.sls.melbase.dao.FinderExecutor;
...
//	}
	...
	public List<T> executeFinder(Method method, final Object[] queryArgs) {
		...
		List<T> list = (List<T>) getJpaTemplate().execute(new JpaCallback<Object>() {
			public Object doInJpa(final EntityManager em) {
