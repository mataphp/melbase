...
/**
 * 
 * Interface pour le DAO du bean de domaine Soc.
 * 
 * Date: 09/09/2012
 * 
 ...
 * @version 1.0
 */
public interface SocDao extends GenericDaoJpa<Soc, Integer> {
	
	/**
	 * Recherche toutes les socs par leur denomination.
	 * @param soc String critère texte denomination
	 * @return Liste de Socs.
	 */
	List<Soc> findBySocLike(String soc);
